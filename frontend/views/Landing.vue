    ...
    <div>
            ...
            <section class="section-shaped my-0">
                ...
                <div class="container shape-container d-flex">
                    <div class="col px-0">
                        <div class="row">
                            <div class="col-lg-6">
                                <h1 class="display-3  text-white">{{introduction.name}}</h1>
                                <p class="lead  text-white">{{introduction.description}}</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="section section-lg pt-lg-0">
            <div class="container">
              <div class="row justify-content-center text-center mb-lg">
                <div class="col-lg-8">
                  <h2 class="display-3">Nos Services</h2>
                </div>
              </div>
                        ...
                        <div class="row row-eq-height">
                            <div class="col-lg-4 my-5" v-for="service in services" :key="service.id">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    <icon :name="`fa fa-${service.icon}`" type="primary" rounded class="mb-4">
                                    </icon>
      ...
      <section class="section section-lg">
        <div class="container">
          <div class="row justify-content-center text-center mb-lg">
            <div class="col-lg-8">
              <h2 class="display-3">Notre Équipe</h2>
            </div>
          </div>
          <div class="row">
            ...
            <div class="container">
                <div class="row row-grid align-items-center">
                    <div class="col-md-6 order-md-2">
                        <img src="static/theme/promo-1.png" class="img-fluid floating">
                    </div>
...
export default {
  ...
  computed: {
    introduction() {
      return this.$store.getters.getIntroduction;
    },
    services() {
